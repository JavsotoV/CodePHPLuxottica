...
class clsgrhTpsolln {
    //put your code here
       public function lst_listar($as_tpsolgrh){
        try{
            $ls_sql="begin
                            gmo.pck_grh_tpsolln.sp_lst_listar (:acr_cursor,
                            :as_tpsolgrh);
                     end;";
            ...
            oci_bind_by_name($stid,':as_tpsolgrh',$as_tpsolgrh,10);
