...
/**
 * Description of clsctbTipocomprobanteimp
 *
 * @author JAVSOTO
 */
...
class clsctbTipocomprobanteimp {
    //put your code here
    
    public function lst_impuesto($an_pai_codigo,$an_tpc_codigo,$ad_fecha){
        
        try{
            $ls_sql="begin
                        pck_ctb_tipocomprobanteimp.sp_lst_impuesto (:acr_cursor,
                            :an_pai_codigo,
                            :an_tpc_codigo,
            ...
            if(!$luo_set->setcrsLst($luo_con, $ls_sql, $stid, $curs)){
             ...
             oci_bind_by_name($stid,':an_tpc_codigo',$an_tpc_codigo,10);
             oci_bind_by_name($stid,':ad_cmp_fecha',$ad_fecha,10);
