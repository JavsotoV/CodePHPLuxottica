...
class clsgccEntidad {
    ...
    public function lst_entidadxjefezonal($an_prc_codigo,$an_pai_codigo,$an_per_zonal,$as_criterio,$an_start,$an_limit){
        try{
            $ln_rowcount=0;
            
            $ls_sql="begin
                        pck_gcc_entidad.sp_lst_entidadxjefezonal (:acr_cursor,
                            :ln_rowcount,
                            :an_prc_codigo,
                            :an_pai_codigo,
                            :an_per_zonal,
