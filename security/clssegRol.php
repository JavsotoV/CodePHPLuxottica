...
class clssegRol {
    ...
    public function sp_seg_rol($an_accion){
        try{
            $ls_sql="begin
                        pck_seg_rol.sp_seg_rol (:an_accion,
                            :acr_retorno,
                            :acr_cursor,
                            :an_rol_codigo,
                            :as_rol_nombre,
            ...
            oci_bind_by_name($stid,':as_rol_nombre',$this->_rol_nombre,120);
            oci_bind_by_name($stid,':as_rol_descripcion',$this->_rol_descripcion,120);
    ...
    public function lst_listar($an_rol_codigo,$as_criterio,$an_start,$an_limit){
        try{
            $ln_rowcount=0;
            
            $ls_sql="begin
                            pck_seg_rol.sp_lst_listar (  :acr_cursor,
                                :ln_rowcount,
                                :an_rol_codigo,
                                :as_criterio,
                                :an_start,
