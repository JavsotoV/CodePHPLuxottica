...
/**
 * Description of clsgcaSituacion
 *
 * @author JAVSOTO
 */
...
class clsgcaSituacion {
    ...
    public function lst_listar($as_condicion){
         ...
         try{
             ...
             if ($as_condicion!=='T'){
             $ls_sql = "begin pck_gca_situacion.sp_lst_listar(:acr_cursor); end;";}
             else
             {$ls_sql= "begin pck_gca_situacion.sp_lst_estado(:acr_cursor); end;";}
