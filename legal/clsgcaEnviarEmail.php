        ...
        if ($this->_rowdata){
            ...
            foreach ($this->_rowdata['data'] as $row) {
                ...
                if ($ln_fila==0){
                    ...
                    $message .= "<tbody><tr>\n\r";
                    $message .= "<td style='background: #d9d9d9 none repeat; border: 1px solid gray;' colspan='2'><strong>CONTRATO MODIFICADO</strong></td></tr>\n\r";
                    $message .= "<tr><td style='dest'>Region</td><td style='dest'><strong>".$row['pai_denominacion']."</strong></td></tr>\n\r";
                    $message .= "<tr><td style='dest'>Nro. Registro</td><td style='dest'><strong>".$row['con_nroregistro']."</strong></td></tr>\n\r";
                    $message .= "<tr><td style='dest'>CECCO</td><td style='dest'><strong>".$row['ctr_codinterno']."</strong></td></tr>\n\r";
                    $message .= "<tr><td style='dest'>Fecha</td><td style='dest'><strong>".$row['log_fecha']."</strong></td></tr>\n\r";
                }
                ...
                if ($ls_entidad!=$row['log_entidad']){
                    ...
                    $message .= "<tr><td align='center' colspan='2' style='dest'><strong>".$row['log_entidad']."</strong></td></tr>\n\r";
                }
                
                $message .= "<tr><td style='dest'>".$row['log_campo'].":</td><td style='dest'>".mb_strtoupper($row['log_valor'],'utf-8')."</td></tr>\n\r";
