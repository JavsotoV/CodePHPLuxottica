    ...
    public function lst_listar(){
        try{
            ...
            if (!$stmt){
                ...
                return clsViewData::showError(-1, 'Error iniciando procedimiento sp_trk_lst_tipocristal');
            }
