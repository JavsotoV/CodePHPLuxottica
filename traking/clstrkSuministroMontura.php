...
/**
 * Description of clstrkSuministroMontura
 *
 * @author JAVSOTO
 */
...
class clstrkSuministroMontura {
    
    public function lst_listar(){
        try{
            $luo_con = new DbSql();
            
            $ls_sql="sp_trk_lst_suministromontura";
            ...
            if (!$stmt){
                ...
                return clsViewData::showError(-1, 'Error iniciando procedimiento sp_trk_lst_suministromontura');
            }
