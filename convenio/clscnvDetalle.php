...
class clscnvDetalle {
    ...
    public function lst_listar($an_reg_codigo,$as_criterio,$an_start,$an_limit){
        try{
            $ln_rowcount=0;
            
            $ls_sql="begin
                        varios.pck_cnv_detalle.sp_cnv_listar (:acr_cursor,
                        :ln_rowcount,
                        :an_reg_codigo,
                        :as_criterio,
                        :an_start,
            ...
            $rowdaraparsear=parsearcursor($curs);
            
            $datarowcol = fn_formatrowcolumn($rowdaraparsear);
             
            $rowdata= clsViewData::viewData($datarowcol,false,$ln_rowcount);
