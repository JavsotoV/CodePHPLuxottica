...
/**
 * Description of clsglbRepresentante
 *
 * @author JAVSOTO
 */
...
class clsglbRepresentante {
    ...
    function set_rpl_codigo($_rpl_codigo) {
        $this->_rpl_codigo = $_rpl_codigo;
    }
    ...
    function set_per_representante($_per_representante) {
        $this->_per_representante = $_per_representante;
    }
    ...
    public function sp_glb_representante($an_accion,$an_usuario){
        try{
            $luo_con=new Db();
            
            $ls_sql="begin pck_glb_representante.sp_glb_representante(
                    :an_accion,
                    :acr_retorno,
                    :acr_cursor,
                    :an_rpl_codigo,
            ...
            oci_bind_by_name($stid,':an_rpl_codigo',$this->_rpl_codigo,10);
            ...
            oci_bind_by_name($stid, ':an_rpl_usuario',$an_usuario,10);
    ...
    public function lst_listar($an_per_codigo){
        try{
            ...
            $ls_sql="begin pck_glb_representante.sp_lst_listar(
                    :acr_cursor,
                    :an_per_codigo,
                    :an_rpl_codigo); end;";
             ...
             oci_bind_by_name($stid,':an_rpl_codigo',$ln_rpl_codigo,10);
