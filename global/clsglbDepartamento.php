...
/**
 * Description of clsglbDepartamento
 *
 * @author JAVSOTO
 */
...
class clsglbDepartamento {
    //put your code here
    public function lst_listar($an_pai_codigo,$as_criterio){
        try{
            
            $ls_sql="begin 
                        pck_glb_departamento.sp_lst_listar(:acr_cursor,
                        :an_pai_codigo,
                        :as_criterio);
                        end;";
