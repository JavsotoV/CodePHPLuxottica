...
class clsprmAtributo {
    //put your code here
    
    public function lst_listar($an_origen){
        try{
            $ls_sql="begin
                            pck_prm_atributo.sp_lst_listar ( :acr_cursor,
                                :an_origen) ;
                     end;";
            ...
            if(!$luo_set->setcrsLst($luo_con, $ls_sql, $stid, $curs)){
             ...
             oci_bind_by_name($stid,':an_origen',$an_origen,10);
