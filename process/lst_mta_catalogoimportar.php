...
if ($imp_origen==2){
        $lst_campos= array('codsap','descripcion','tarifa','precio','precioiva');
    
}

if ($imp_origen==3){
            $lst_campos= array('codsap','descripcion','descatalogado');            
}
            ...
            if ($imp_origen==1) {
                ...
                if ($tipfamcod=='G') {
                    array_push ( $rowdata, [ $lst_campos[0]=>$data[0],
                                             ...
                                             $lst_campos[25]=>$data[25],
                                             $lst_campos[26]=>$data[26]] );}
                if ($tipfamcod=='L'){
                      array_push ( $rowdata, [ $lst_campos[0]=>$data[0],
                                             $lst_campos[1]=>$data[1],
                                             $lst_campos[2]=>$data[2],
