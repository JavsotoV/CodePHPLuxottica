...
/**
 * Description of clsmtaGrupofamilia
 *
 * @author JAVSOTO
 */
...
class clsmtaGrupofamilia {
    //put your code here
    
    public function lst_listar($an_sfa_codigo,$as_criterio,$an_start,$an_limit){
        try{
            $ln_rowcount=0;
            
            $ls_sql="begin
                        pck_mta_grupofam.sp_lst_listar (:acr_cursor,
                            :ln_rowcount,
                            :an_sfa_codigo,
                            :as_criterio,
                            :an_start,
