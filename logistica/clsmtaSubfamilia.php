...
/**
 * Description of clsmtaSubfamilia
 *
 * @author JAVSOTO
 */
...
class clsmtaSubfamilia {
    //put your code here
    
    public function lst_listar($an_fam_codigo,$as_criterio,$an_start,$an_limit){
        try{
            $ln_rowcount=0;
            
            $ls_sql="begin
                pck_mta_subfamilia.sp_lst_listar (:acr_cursor,
                    :ln_rowcount,
                    :an_fam_codigo,
                    :as_criterio,
                    :an_start,
