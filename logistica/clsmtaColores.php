...
class clsmtaColores {
    ...
    public function lst_listar($an_pai_codigo,$as_tipfamcod,$as_col_entidad){
        try{
            $ls_sql="begin
                        pck_mta_colores.sp_lst_listar (:acr_cursor,
                            :an_pai_codigo,
                            :as_tipfamcod,
                            :as_col_entidad);
                     end;";
            ...
            if(!$luo_set->setcrsLst($luo_con, $ls_sql, $stid, $curs)){
             ...
             oci_bind_by_name($stid,':as_col_entidad',$as_col_entidad,120);
